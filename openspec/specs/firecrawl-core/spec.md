...
Define the Firecrawl core services: api, playwright-service, redis, rabbitmq, and nuq-postgres — all using upstream images with proper networking, persistence, and configuration.
